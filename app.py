...
def main():
    ...
    if website_menu == "Emotion Recognition":
        ...
        st.subheader("Power of Voice")
        link = '[Research paper]' \
               '(https://ieeexplore.ieee.org/document/9383000)'
        ...
        txt = """
            This web-application is a part of the final **Data Mining** project for **TyBSC IT**. 
        ...
        st.write("Since we are currently using a free tier instance of AWS, "
                 ...
                 "Thankyou !")
        st.code("https://ieeexplore.ieee.org/document/9383000", language='bash')

        st.write("you can also comment and let us know any query or ideas:")
